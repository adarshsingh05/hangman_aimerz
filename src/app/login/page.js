...
export default function LoginPage() {
  ...
  useEffect(() => {
    if (formRef.current) {
      validatorRef.current = createFormValidator(formRef.current, VALIDATION_RULES.LOGIN);
    }
  }, []);
    ...
    <div className="min-h-screen bg-white dark:bg-black flex items-center justify-center p-6">
      <div className="max-w-md w-full">
        ...
        <div className="text-center mb-12">
          <h1 className="text-3xl font-light text-black dark:text-white mb-4 tracking-tight">
            HANGMAN
          </h1>
        ...
        <div className="card-elevated p-8">
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-gray-600 dark:text-gray-400 font-light">
              ...
              <Link href="/signup" className="text-black dark:text-white hover:text-gray-600 dark:hover:text-gray-400 font-medium transition-colors">
                Sign up here
              </Link>
            </p>
          </div>
